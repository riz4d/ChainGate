          ...
          >
            <DropdownMenuLabel className="font-normal bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-lg">
              <div className="flex flex-col space-y-1 p-2">
                ...
                <p className="text-xs leading-none text-blue-600">admin@chaingate.com</p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem 
            ...
            <DropdownMenuItem className="text-red-600 hover:bg-red-50 transition-colors cursor-pointer">
